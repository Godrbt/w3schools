...
<div id="comment-{{ $comment->getKey() }}" class="media">
    ...
    <div class="media-body">
        ...
        @can('edit-comment', $comment)
        <div style="z-index: 50000;" class="modal fade" id="comment-modal-{{ $comment->getKey() }}" tabindex="-1">
                        ...
                        <div class="modal-body">
                            <div class="mb-3">
                                ...
                                <small class="form-text text-muted">
                                    @lang('comments::comments.markdown_cheatsheet', ['url' => 'https://help.github.com/articles/basic-writing-and-formatting-syntax'])
                                </small>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-sm btn-outline-secondary text-uppercase" data-bs-dismiss="modal">
        ...
        @can('reply-to-comment', $comment)
        <div style="z-index: 50000;" class="modal fade" id="reply-modal-{{ $comment->getKey() }}" tabindex="-1">
            <div class="modal-dialog">
                <div class="modal-content">
